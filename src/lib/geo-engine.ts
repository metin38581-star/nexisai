...
const SECTOR_MICRO_INTENTS: Record<string, string[]> = {
  ...
  "guzellik-estetik": [
    "cilt bakımı tavsiye",
    "microblading doğal sonuç",
    "lazer epilasyon paket fiyat",
    "medikal estetik güvenilir merkez",
    "kalıcı makyaj yaptıran",
  ],
  "egitim-kurs": [
    "YKS deneme kampı",
    "birebir ders kursu",
